...
layer1_name = "a_predios_camargo"
layer2_name = "a_predios_agregado_010701"
...
orden_manz_index1 = layer1.fields().indexFromName("segmento")


# Obtener los índices de los campos en el layer2
orden_manz_index2 = layer2.fields().indexFromName("segmento")
...
for feature2 in layer2.getFeatures():
    ...
    if feature_id in inherited_values:
        ...
        feature2[orden_manz_index2] = values["segmento"]
